              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    height: 80,
                    width: 250,
                    child: Center(child: Text('${weatherModel.cityName}', style: TextStyle(fontSize: 35, fontFamily: AutofillHints.addressCity))),
                  ),
                  Center(child: Text('Updated at ${weatherModel.date.hour}:${weatherModel.date.minute}')),
                  SizedBox(
                    height: 140,
                    width: 300,
                    child: Center(child: Text('${weatherModel.temp.round()}° C', style: TextStyle(fontSize: 45))),
                  ),
                  SizedBox(
                    height: 80,
                    width: 600,
